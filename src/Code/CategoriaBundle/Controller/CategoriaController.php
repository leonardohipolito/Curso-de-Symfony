...
use Code\CategoriaBundle\Form\CategoriaType;
...
class CategoriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CodeCategoriaBundle:Categoria')->findAll();
     ...
     * @Method("POST")
     * @Template("CodeCategoriaBundle:Categoria:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CodeCategoriaBundle:Categoria')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CodeCategoriaBundle:Categoria:edit.html.twig")
     */
